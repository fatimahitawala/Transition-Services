...
## About
Modular Tenancy Management Backend for Sobha Smart FM. Includes MoveIn, MoveOut, Renewal, Documents, Integration, and Webhook modules with full API documentation."
...
- Move In Request Workflow
- Move Out Request Workflow
- Account Renewal Request Workflow
- Auto DeLinking of User Access and Bookings related to that unit.
